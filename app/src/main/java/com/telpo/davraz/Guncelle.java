    ...
    public Guncelle(Database myDb, MainActivity activity) {
        ...
        veriIletimiTimer.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                veriIletimiTimer.postDelayed(this,120000);
            }
        }, 10);
    }

    public void start(){
        Log.i("KURULUM","VAR");tanimliKartlarGuncelle();
    }

    public void tanimliKartlarGuncelle(){
                            ...
                            try {
                                ...
                                for (String uid : parts) {
                                    ...
                                    if(!image.exists()){
                                        ...
                                        activity.downloadImageNew(uid,ipAdresi+":"+apiPort+"/api/user/image/"+uid);
                                    }
                                }
