...
public class Settingss extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try{
            ...
            Toast.makeText(Settingss.this,"Cihaz çevrimdışı modda çalışıyor.",Toast.LENGTH_LONG).show();
        }
    ...
    {
        Activity activity = Settingss.this;
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            startActivity(new Intent(Settingss.this,MainActivity.class));
            finish();
        }
    ...
    public void alertDialog(String title, String message){
        runOnUiThread(() -> new AlertDialog.Builder(Settingss.this)
                .setTitle(title)
                .setMessage(message)
                .setCancelable(false)
    ...
    private void setDefaultCosuPolicies(boolean active){
        ...
        if (active) {
            ...
            // on reboot
            mDevicePolicyManager.addPersistentPreferredActivity(mAdminComponentName, intentFilter, new ComponentName(getPackageName(), Settingss.class.getName()));
        } else {
